...
class Seq2SeqModel:
    ...
    def build_model(self):
        ...
        with tf.variable_scope('decoder'):
            ...
            if self.mode == 'train':
                ...
                self.decoder_logits_train = tf.identity(decoder_outputs.rnn_output,'logits')
                # self.decoder_predict_train = tf.argmax(self.decoder_logits_train, axis=-1, name='')
    ...
    def train(self, sess, batch):
        ...
        feed_dict = {self.encoder_inputs: batch.encoder_inputs,
                      ...
                      self.keep_prob_placeholder: 0.3,
                      self.batch_size: len(batch.encoder_inputs)}
        print("1=== ", batch.encoder_inputs)
        print("2=== ", batch.encoder_inputs_length)
        print("3=== ", batch.decoder_targets)
        print("4=== ", batch.decoder_targets_length)

        _, _loss, _summary = sess.run([self.train_op, self.loss, self.summary_op], feed_dict=feed_dict)
        return _loss, _summary
